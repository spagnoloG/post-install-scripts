...
vim.g.vimtex_quickfix_ignore_filters = {
    "Command terminated with space", "LaTeX Font Warning: Font shape",
...
vim.g.vimtex_fold_types = {
    ...
    cmd_multi = {
        cmds = {
            "%(re)?new%(command|environment)", "providecommand", "presetkeys",
    ...
    cmd_single_opt = {cmds = {"usepackage", "includepdf"}},
    comments = {enabled = 0},
    ...
    sections = {
        ...
        sections = {
            "%(add)?part", "%(chapter|addchap)", "%(section|section\\*)",
